        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('restore')
                    ...
                    ->visible(fn (Audit $record, RelationManager|ManageRelatedRecords $livewire): bool => Filament::auth()->user()->can('restoreAudit', $this->getOwnerRecord() ?? $livewire->ownerRecord) && $record->event === 'updated')
